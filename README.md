...
```bash
git clone https://github.com/gauravdixit011/50-loader-spinner-html-css-js.git
...
<div class="loaders-grid">
    <div class="loader-card">
        ...
        <div class="loader-info">
            <div class="loader-title">Loader 1 · Basic</div>
...
```
50-loaders/
├── index.html              # Complete loader showcase
